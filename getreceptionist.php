...
$ins = "SELECT * FROM receptionist";
$query1 = mysqli_query($connection, $ins);
// $rows_receptionist = $query1->fetch_all(MYSQLI_ASSOC);
?>
      ...
      <div class="s-layout__sidebar">
        ...
        <nav class="s-sidebar__nav">
          <ul>
            ...
            <li>
              <a class="s-sidebar__nav-link s-active" href="./getreceptionist.php">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td> 
                      <a href="delete.php?table=receptionist&delete=<?php echo $rows['no'];?>" ><button><i class="fas fa-trash"></i></button></>
                    </td>
                  </tr>        
                <?php 
                }

...
$ins = "SELECT * FROM coach";
$query1 = mysqli_query($connection, $ins);
// $rows_coach = $query1->fetch_all(MYSQLI_ASSOC);
?>
    ...
    <div class="s-layout__sidebar">
      ...
      <nav class="s-sidebar__nav">
        <ul>
          ...
          <li>
            <a class="s-sidebar__nav-link s-active" href="./getcoach.php">
      ...
      <div class="table-wrapper">
        ...
        ?>
            <tr>
              ...
              <td> 
                <a href="delete.php?table=coach&delete=<?php echo $rows['no'];?>" ><button><i class="fas fa-trash"></i></button></>
              </td>
            </tr>        
          <?php  
            }

...
$ins = "SELECT * FROM billing";
$query1 = mysqli_query($connection, $ins);
// $rows_billing = $query1->fetch_all(MYSQLI_ASSOC);
...
<!-- Sidebar -->
  <div class="s-layout__sidebar">
    ...
    <nav class="s-sidebar__nav">
      <ul>
        <li>
          <a class="s-sidebar__nav-link s-active" href="./getbilling.php">
        ...
        <li>
          <a class="s-sidebar__nav-link" href="./getmember.php">
      ...
      <table class=fl-table id="sex">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
              <a href="delete.php?table=billing&delete=<?php echo $rows['no'];?>" ><button><i class="fas fa-trash"></i></button></>
            </td>
          </tr>        
          <?php 
            }
...
<!-- <script>
  let table = document.getElementById("sex");
  let cells = table.getElementsByTagName("td");
    ...
    for (let i = 0; i < cells.length; ++i) {
        ...
        cell.addEventListener("click", (e)=>{
          console.log(e.target.parentNode.rowIndex-1)
        });
    }
